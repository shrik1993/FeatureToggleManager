...
function generate_team_accordian(team_id) {
    var team_accordian = '<div class="panel-heading" role="tab" id="heading' + team_id + '">' +
        ...
        '<a role="button" data-toggle="collapse" href="#collapse_' + team_id + '" aria-expanded="true" aria-controls="collapse_' + team_id + '">' + team_id + '</a>' +
        '</h4>' +
        '</div>' +
        '<div id="collapse_' + team_id + '" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_' + team_id + '">' +
